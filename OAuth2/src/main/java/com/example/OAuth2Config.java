...
//				.authorizedGrantTypes("authorization_code", "refresh_token", "password").accessTokenValiditySeconds(3)
//				.refreshTokenValiditySeconds(3).scopes("sso1", "sso2").and().withClient("acme2").secret("acmesecret2")
//				.autoApprove(true).authorizedGrantTypes("authorization_code", "refresh_token", "password")
//				.accessTokenValiditySeconds(3).refreshTokenValiditySeconds(3).scopes("sso1", "sso2");
//		;
//	}
